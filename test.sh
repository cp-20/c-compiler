...
assert "int main() { a = 3; print(a++); print(a); }" "3 4"
assert "int main() { a = 3; print(a--); print(a); }" "3 2"
assert "int main() { a = 3; print(++a); print(a); }" "4 4"
assert "int main() { a = 3; print(--a); print(a); }" "2 2"

describe "ローカル変数"
assert "int main() { a = 3; print(a); }" "3"
assert "int main() { aaa = 3; bbbb = 5; print(aaa + bbbb); }" "8"
assert "int main() { a = 3; b = 5; a = 4; print(a + b); }" "9"
assert "int main() { a = b = 3; print(a * 2 * b); }" "18"

describe "return文"
assert "int main() { print(func()); } int func() { return 3; }" "3"
assert "int main() { print(func()); } int func() { return 3; return 5; }" "3"
assert "int main() { print(func()); } int func() { return 3; return 5; }" "3"
assert "int main() { print(func()); } int func() { a = 3; return a; }" "3"
assert "int main() { print(func()); } int func() { a = 3; b = 5; return a + b; }" "8"
assert "int main() { print(func()); } int func() { a = 3; b = 5; return a + b; return a * b; }" "8"
...
describe "while文"
assert "int main() { a = 0; while (a < 3) a = a + 1; print(a); }" "3"
assert "int main() { a = 2; while (a < 16) a = a * 2; print(a); }" "16"
assert "int main() { a = 0; b = 1; while (a < 55) a = ((b = (a + b)) - a); print(a); }" "55"

describe "for文"
assert "int main() { a = 0; for (i = 0; i < 3; i = i + 1) a = a + 1; print(a); }" "3"
assert "int main() { a = 2; for (i = 0; i < 3; i = i + 1) a = a * 2; print(a); }" "16"
assert "int main() { a = 0; b = 1; for (i = 0; i < 10; i = i + 1) a = ((b = (a + b)) - a); print(a); }" "55"

describe "ブロック"
assert "int main() { { print(3); } }" "3"
assert "int main() { { a = 3; print(a); } }" "3"
assert "int main() { a = 0; b = 1; for (i = 0; i < 10; i = i + 1) { tmp = b; b = a + b; a = tmp; } print(a); }" "55"
